...
public interface CalcModel {
	...
	/**
	 * Zamrzava vrijednost koja je trenutno zapisana na ekranu
	 * kalkulatora kada se pritisne neki od binarnih operatora.
	 * @param value vrijednost koja se "zamrzne" tj. zapamti.
	 */
