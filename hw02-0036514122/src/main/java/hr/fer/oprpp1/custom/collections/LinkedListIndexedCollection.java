...
public class LinkedListIndexedCollection implements List {
	...
	private static class ElementsGetter implements IElementsGetter {
		private LinkedListIndexedCollection list;
		private ListNode currentNode;
		private long savedModificationCount;
		
		private ElementsGetter(LinkedListIndexedCollection list, long savedModificationCount) {
			this.list = list;
		...
		public void processRemaining(Processor p) {
			for(ListNode n = currentNode; n != null; n = n.next) {
				p.process(n.value);
			}
	...
	@Override
	public IElementsGetter createElementsGetter() {
		return new ElementsGetter(this, modificationCount);
	}
